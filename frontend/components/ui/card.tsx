...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn(
        'flex min-w-0 flex-col gap-5 border bg-card text-card-foreground py-5',
...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('text-base font-semibold leading-tight tracking-tight md:text-[17px]', className)}
      {...props}
    />
  );
}
